...
import { Credential, isString, type StorableCredential } from "@hyperledger/identus-domain";
import { CredentialType, AnonCredsRecoveryId } from "@hyperledger/identus-domain";
import { AnonCredsCredentialProperties } from "../types";
