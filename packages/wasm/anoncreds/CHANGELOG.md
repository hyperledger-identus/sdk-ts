...
- Updated @hyperledger/identus-domain to 0.1.1
...
- initialise submodules in readme build from source section ([#514](https://github.com/hyperledger-identus/sdk-ts/pull/514))
- package dependency ranges ([#513](https://github.com/hyperledger-identus/sdk-ts/pull/513))
...
- Updated @hyperledger/identus-domain to 0.1.0
