...
Defined in: [src/domain/models/errors/Pollux.ts:86](https://github.com/hyperledger/identus-edge-agent-sdk-ts/blob/96423ee84b124a31ce63036d9d623d1cb73a13c2/src/domain/models/errors/Pollux.ts#L86)
...
> **new InvalidVerifyCredentialError**(`credentialId`: `string`, `reason`: `string`): `InvalidVerifyCredentialError`

Defined in: [src/domain/models/errors/Pollux.ts:87](https://github.com/hyperledger/identus-edge-agent-sdk-ts/blob/96423ee84b124a31ce63036d9d623d1cb73a13c2/src/domain/models/errors/Pollux.ts#L87)
...
| <a id="reason"></a> `reason` | `public` | `string` | - | - | [src/domain/models/errors/Pollux.ts:87](https://github.com/hyperledger/identus-edge-agent-sdk-ts/blob/96423ee84b124a31ce63036d9d623d1cb73a13c2/src/domain/models/errors/Pollux.ts#L87) |
