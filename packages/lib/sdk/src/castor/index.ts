...
import { DIDDocument, type PrismDIDKeys, PrismDIDKeyUsage, type PrismDIDKeyUsageType } from "@hyperledger/identus-domain";
...
export class Castor implements Domain.Castor {
   ...
   *
   * @private
   * @param {DIDDocument.CoreProperty[]} coreProperties
