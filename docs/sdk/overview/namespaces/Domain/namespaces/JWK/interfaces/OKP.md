...
Defined in: packages/shared/domain/build/index.d.ts:675
...
| <a id="property-crv"></a> `crv` | `string` | - | - | packages/shared/domain/build/index.d.ts:677 |
| <a id="property-d"></a> `d?` | `string` | - | - | packages/shared/domain/build/index.d.ts:678 |
...
| <a id="property-kty"></a> `kty` | `"OKP"` | [`Base`](Base.md).[`kty`](Base.md#property-kty) | - | packages/shared/domain/build/index.d.ts:676 |
| <a id="property-use"></a> `use?` | `"sig"` \| `"enc"` | - | [`Base`](Base.md).[`use`](Base.md#property-use) | packages/shared/domain/build/index.d.ts:657 |
| <a id="property-x"></a> `x` | `string` | - | - | packages/shared/domain/build/index.d.ts:679 |
