...
import { Curve, KeyProperties, KeyTypes, DeprecatedDerivationPath, PrismDerivationPath, ApolloError } from '@hyperledger/identus-domain';
  ...
  describe("Secp256k1", () => {
    describe("PrivateKey", () => {
      ...
      test("invalid key size - throws", () => {
        ...
        expect(() => new Secp256k1PrivateKey(raw)).throws(ApolloError.KeyInitializationError);
      });
    ...
    describe("PublicKey", () => {
      test("invalid raw length - throws", () => {
        ...
        expect(() => new Secp256k1PublicKey(raw)).throws(ApolloError.KeyInitializationError);
      });
