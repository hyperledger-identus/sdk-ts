...
> `const` **fromKey**: (`key`: [`PublicKey`](../../../classes/PublicKey.md) \| [`PrivateKey`](../../../classes/PrivateKey.md), `base?`: [`Base`](../interfaces/Base.md)) => [`JWK`](../../../type-aliases/JWK.md)

Defined in: packages/shared/domain/build/index.d.ts:704
