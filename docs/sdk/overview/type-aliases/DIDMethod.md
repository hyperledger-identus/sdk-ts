...
Defined in: [packages/lib/sdk/src/castor/methods/types.ts:54](https://github.com/hyperledger-identus/sdk-ts/blob/170e1efdccd6a1bbc55c6992c3fbf0ba2b84a0ed/packages/lib/sdk/src/castor/methods/types.ts#L54)
...
| ------ | ------ | ------ |
| `create()` | (`opts`: `CreatePayload`) => `Promise`\<[`DID`](../namespaces/Domain/classes/DID.md)\> | [packages/lib/sdk/src/castor/methods/types.ts:63](https://github.com/hyperledger-identus/sdk-ts/blob/170e1efdccd6a1bbc55c6992c3fbf0ba2b84a0ed/packages/lib/sdk/src/castor/methods/types.ts#L63) |
| `method` | `string` | [packages/lib/sdk/src/castor/methods/types.ts:62](https://github.com/hyperledger-identus/sdk-ts/blob/170e1efdccd6a1bbc55c6992c3fbf0ba2b84a0ed/packages/lib/sdk/src/castor/methods/types.ts#L62) |
| `resolver` | [`DIDResolver`](../namespaces/Domain/classes/DIDResolver.md) | [packages/lib/sdk/src/castor/methods/types.ts:61](https://github.com/hyperledger-identus/sdk-ts/blob/170e1efdccd6a1bbc55c6992c3fbf0ba2b84a0ed/packages/lib/sdk/src/castor/methods/types.ts#L61) |
