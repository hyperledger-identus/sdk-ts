...
export namespace JWK {
  ...
  export const fromKey = (key: PublicKey | PrivateKey, base: Base = {}): JWK => {
    ...
    const privateFn = key.curve === Curve.SECP256K1.toString() ? privateKeyToEC : privateKeyToOKP;
    const publicFn = key.curve === Curve.SECP256K1.toString() ? publicKeyToEC : publicKeyToOKP;
