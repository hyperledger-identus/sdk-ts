...
// JWT with VCDM-valid vc: @context, type, issuer (from iss), issuanceDate (from nbf), credentialSubject
// Signed with Fixtures.Keys.secp256K1 (prismDIDDefault) - run tests/fixtures/generate-credential-data-jwt.test.ts to regenerate
