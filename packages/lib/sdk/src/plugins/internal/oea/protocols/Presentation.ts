...
import { AgentError, type AttachmentDescriptor, type DID, Message } from "@hyperledger/identus-domain";
...
export class Presentation {
  public static type = OEA.ProtocolIds.Presentation;
  ...
  static fromMessage(fromMessage: Message): Presentation {
    if (
      fromMessage.piuri !== OEA.ProtocolIds.Presentation ||
      !fromMessage.from ||
      !fromMessage.to
    ) {
