...
import { AgentContext, Apollo, Castor, Domain, Secp256k1PrivateKey } from "../../src";
import * as Fixtures from "../fixtures";
import { Task } from '../../src/utils';
import { FindSigningKeys, SigningKeyData } from '../../src/edge-agent/didFunctions/FindDIDSigningKeys';
...
describe("Domain - JWT", () => {
  ...
  describe("sign", () => {
    ...
    describe("purpose", () => {
      let findSigningKeysSpy: MockInstance<(ctx: AgentContext) => Promise<SigningKeyData[]>>;
  ...
  describe("decode", () => {
    ...
    test("invalid jws - throws", async () => {
      ...
      await expect(result).rejects.toThrow(Domain.PolluxError.InvalidJWTString);
    });
  });
