...
Defined in: packages/shared/domain/build/index.d.ts:671
...
| <a id="property-k"></a> `k` | `string` | - | - | packages/shared/domain/build/index.d.ts:673 |
...
| <a id="property-kty"></a> `kty` | `"oct"` | [`Base`](Base.md).[`kty`](Base.md#property-kty) | - | packages/shared/domain/build/index.d.ts:672 |
